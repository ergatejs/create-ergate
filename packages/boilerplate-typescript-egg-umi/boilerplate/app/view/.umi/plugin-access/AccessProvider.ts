...
import { traverseModifyRoutes } from '/Users/suyi/gpm/github.com/ergatejs/boilerplate/node_modules/@umijs/plugin-access/lib/utils/runtimeUtil';
...
const AccessProvider: React.FC<Props> = (props) => {
  if (typeof useModel !== 'function') {
    throw new Error(
      '[plugin-access]: useModel is not a function, @umijs/plugin-initial-state is needed.',
    );
  }
  ...
  props.routes.splice(
    0,
    props.routes.length,
    ...traverseModifyRoutes(props.routes, access),
  );
